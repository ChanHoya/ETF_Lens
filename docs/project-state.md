...
✅ Current: 계좌 명칭 순번 포맷팅(연동계좌 1 (계좌번호)...) 드롭다운 및 비교 차트 범례/툴팁 통일 연동 완료 (2026-08-06)
➡️ Next: S6-4 ETF 배당(분배금) 정보 수집 백엔드 스크래퍼 및 API

> 세션 핸드오프 (2026-08-06):
> - 자산 성장 추이(AssetHistoryChart) 드롭다운 선택지 및 비교 차트 범례/툴팁의 계좌명을 `연동계좌 1 (64490078-01)`, `연동계좌 2 (81060777-22)` 형식으로 순번 명시 포맷팅 통일.
