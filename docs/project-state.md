...
✅ Current: Sprint 6 — COPOM 발표 실시간 텔레그램 모니터링 15분 주기 수집 및 Selic 금리 변경 전용 핫 알림 고도화 완료 (2026-07-25)
➡️ Next: S6-4 ETF 배당(분배금) 정보 수집 백엔드 스크래퍼 및 API

> 세션 핸드오프 (2026-07-25):
> - COPOM 금리 발표 및 장중 매크로 지표 변동에 즉각 대응하도록 백엔드 스케줄러를 15분 간격 실시간 모니터링(_job_brazil_intraday)으로 강화했습니다.
> - BCB SGS에서 COPOM 금리 수치가 갱신될 경우 이전 금리 대비 변동폭 및 방향(인상/인하)을 감지하여 텔레그램 긴급 핫 알림을 발송하는 전용 감지 로직을 구현했습니다.
