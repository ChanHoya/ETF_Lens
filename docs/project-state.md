...
| S5-12 | ETF 구성종목(CU) 데이터 보완 및 yfinance dynamic holdings 연동 | ✅ done | 미국 ETF 최신 구성종목 dynamic 연동 및 국내 상장 해외/합성 ETF의 주식수 기반 비율 차트 렌더링과 비중 fallback 연동 완료 |
