...
| TFF 상세 데이터 카드화 | 🔧 active | dashboard/src/components/tff/views/PortfolioDetailView.tsx | 카드형 UI 전환 및 상세 성과 지표 추가 |
...
| 섹터별 상관관계 히트맵 | ⬜ planned | - | 섹터 간 상관계수 분석 및 포트폴리오 영향 분석 |
