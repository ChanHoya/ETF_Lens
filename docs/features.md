...
| 브라질 채권 분석 (Selic vs Y5) | ✅ done | backend/api/brazil_bond.py, brazil_fetcher.py, scheduler.py, BrazilBondTab.tsx | FRED 10년 역사적 금리/Investing.com 연동 차트, 10Y/1Y/6M/3M 필터, COPOM 기준금리 변경 감지 전용 핫 알림 및 15분 주기 실시간 동기화 모니터링 연동 |
