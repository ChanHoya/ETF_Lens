...
- [x] 효율적 전선 세부 튜닝:
  - [x] 효율적 전선 해석/활용 가이드 설명 팝업 모달 추가 및 정보(Info) 아이콘 배치
  - [x] 최적 비중 비교 차트 Y축 너비(width={150}) 확장 및 종목명 자르기 글자 수(16자) 상향
  - [x] 최적 비중 비교 차트 X축 도메인을 [0, 'dataMax']로 변경해 가로 바의 시인성 확대
